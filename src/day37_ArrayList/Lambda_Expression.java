...
public class Lambda_Expression {
    public static void main(String[] args) {
        ...
        list.addAll(Arrays.asList(1, 1, 2, 3, 3, 4, 5, 6, 7, 8, 8, 9));

       // Predicate<Integer> lessThan5 = p -> p<5;
        // list.removeIf(lessThan5);
        list.removeIf(p->p<=5);  // works both ways
        ...
        System.out.println(numbers);// it will remove all odd and even numbers
        System.out.println("===============================");
